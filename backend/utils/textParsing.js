...
//   @[Display Name](<userId>)         -> mention of a person
//   @company[Display Name](<userId>)  -> mention of a company (an employer
//                                        account is just a User with
//                                        role: "employer" — same id space,
//                                        just tagged so the frontend knows
//                                        to link to /community/company/:id
//                                        and render the company icon
//                                        instead of treating it as a person)
...
const MENTION_RE = /@(?:company)?\[([^\]]{1,80})\]\(([a-f0-9]{24})\)/g;

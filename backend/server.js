...
app.use("/api/jobseeker/cover-letters", require("./routes/coverLetterRoutes"));
app.use("/api/ai/cover-letter", require("./routes/coverLetterAiRoutes"));
...
app.use("/api/community/users", require("./routes/followRoutes"));

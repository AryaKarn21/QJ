      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2 pr-10 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ${formErrors.password ? 'border-red-500' : ''}`}
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2 pr-10 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ${formErrors.confirmPassword ? 'border-red-500' : ''}`}

...
const Profile = () => {
  ...
  if (loading) {
    return (
      <div className="bg-[#F8FAFC] min-h-[calc(100dvh-50px)] p-6 md:p-8 flex items-center justify-center">
  ...
  if (!profile) {
    ...
    if (loadError?.forbidden) {
      return (
        <div className="bg-[#F8FAFC] min-h-[calc(100dvh-50px)] p-8 flex items-center justify-center">
  ...
  return (
    <div className="bg-[#F8FAFC] p-4 sm:p-6 lg:p-8 min-h-[calc(100dvh-50px)] overflow-y-auto selection:bg-orange-500 selection:text-white">
